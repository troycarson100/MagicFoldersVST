...
CLASS_CONFIG: dict[str, dict] = {
    ...
    "Lead": {
        "oneshot_queries": [
            ...
            "square wave synth note",
        ],
        "loop_queries": [
            "synth lead loop",
            "lead melody loop",
            "monophonic lead loop",
            "sawtooth lead loop",
            "arp lead loop",
            "arp synth loop",
            "supersaw lead loop",
    ...
    "FX": {
        "oneshot_queries": [
            ...
            "synth sweep fx",
            "impact sound effect",
            "sweep transition sound",
            "transition fx hit",
            "noise sweep one shot",
            "whoosh sound effect",
            "downlifter fx",
            "audio fx sound effect",
            "reverse cymbal fx",
        ],
        "loop_queries": [
            "fx loop",
    ...
    "TextureAtmos": {
        "oneshot_queries": [
            ...
            "spatial texture ambient",
        ],
        "loop_queries": [
            "ambient texture loop",
            "atmospheric texture loop",
...
def main() -> None:
    ...
    parser.add_argument(
        "--per-class", type=int, default=2000,
        help="Target number of one-shots per class (default 2000)",
    )
    parser.add_argument(
        "--loops-per-class", type=int, default=1000,
        help="Target number of loops per class (default 1000). Stored in <Class>/loops/.",
    )
    parser.add_argument(
